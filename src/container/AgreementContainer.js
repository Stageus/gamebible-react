...
import PrivacyServiceContainer from "./PrivacyServiceContainer";
...
const AgreementContainer = () => {
  ...
  return (
    <>
      ...
      {termsReadMore && <TermsServiceContainer {...{ termsReadMoreEvent }} />}
      {privacyReadMore && <PrivacyServiceContainer {...{ privacyReadMoreEvent }} />}
    </>
  );
};
