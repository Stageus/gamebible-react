  ...
  return (
    <>
      ...
      >
        <TitleDiv $width="100%" $height="100%">
          <Div $flex="h_start_start">
            ...
            <P $fontSize="large" $color="white" $margin="0 5px">
              :
            </P>
          ...
          <Div>
            <Div $flex="h_start_start">
              ...
              <P $fontSize="small" $color="white" $margin="0 5px">
                :
              </P>
              <P $fontSize="small" $color="white">
                {dummyData.nickName}
              </P>
              <P $fontSize="small" $color="white" $margin="0 10px">
                |
              </P>
              <P $fontSize="small" $color="white">
                {dummyData.date}
      ...
      <Section
        ...
        $margin="0 0 1px 0"
      >
        {dummyData.htmlContext}
        <Div $padding="5%" dangerouslySetInnerHTML={{ __html: dummyData.htmlContent }}></Div>
      </Section>
      <Section $width="100%" $padding="10px 30px" $backgroundColor="major">
        <CommentListItem
          {...{
            title: dummyCommentData.title,
            nickName: dummyCommentData.nickName,
            createdAt: dummyCommentData.createdAt,
          }}
        />
        <CommentListItem
          {...{
